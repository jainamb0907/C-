...
>>>>>>> 72852c5 (Completed Array, Multidimentional array, jagged array)
                ...
                Console.WriteLine("address of the n: " + (int)&n);

                Console.WriteLine("Value of n using pointer: " + *p1);
                Console.WriteLine("Addess of the n using pointer or value stored by the pointer itself: " + (int)p1);
                Console.WriteLine("Addess of the pointer itself: " + (int)&p1);

                Console.WriteLine("Value of n:{0}", n);
                Console.WriteLine("Address of n:{0}", (int)p);
            }
        }
    }
}
