    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            unsafe
            {
                ...
                Console.WriteLine(
                    "Addess of the n using pointer or value stored by the pointer itself: "
                        + (long)p1
                );
                ...
                //Syntax: data_type.Parse(string);
                string var_string = "4.5";

                Console.WriteLine(int.Parse("4") + 3);
                Console.WriteLine(float.Parse(var_string) + 4.4f);

                Console.WriteLine(int.Parse("Seven") + 1); // produces an exception of the incorrect format

                //Syntax: data_type.TryParse(string, out output_variable);
